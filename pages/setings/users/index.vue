    ...
    <div class="rent21Grid">
      ...
      font-size: 12px;overflow-y: scroll" ref="scroll">
        <div v-for="(item, index) in items" :key="index" class="item">
          <div class="hdiv"></div>
          <div class="itemRow" style="width: 240px">{{item.email}}</div>
          <div class="hdiv"></div>
          <div class="itemRow" style="width: 210px">{{item.title}}</div>
          <div class="hdiv"></div>
          <div class="itemRow" style="flex: auto;">
            <userAccess :userId="item.id" :item="item" field="dostup" />
          </div>
          <div class="hdiv"></div>
          <div class="itemRow" style="width: 120px">{{item.tip}}</div>
          <div class="hdiv"></div>
...
<script>
import UserAccess from '@/components/rent21/ui/user/access'
export default {
  name: 'index',
  ...
  mounted () {
    ...
    this.resize()
    this.$axios.get('/api/rent21/setings/users').then(item=>{
