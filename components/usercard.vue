<template>
  <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)">
    ...
    <img v-if="user.default_avatar_id" class="img-90 rounded-circle" style="width: " :src="'https://avatars.yandex.net/get-yapic/'+user.default_avatar_id+'/islands-retina-50'" alt="">
    <img v-else class="img-90 rounded-circle" src="images/dashboard/1.png" alt="">
    <div class="badge-bottom"><span class="badge badge-primary">New</span></div>
    <a href="user-profile.html">
      <h6 class="mt-3 f-14 f-w-600">{{user.real_name}}</h6></a>
...
export default {
  ...
  mounted () {
    this.$axios.get('https://rent21.ru:4439/apiv2/').then((item) => {
      this.user = item.data;
    });
  }
}
