    ...
    return function(t) {
        ...
        o.prototype = {
            _parseInner: function(t) {
                for (var e = null, i = [], n = 0, a = t.length; n < a; n++) e = t[n], this.$initItem && (e = this.$initItem(r.copy(e))), this.callEvent("onItemLoading", [e]) && (this.pull.hasOwnProperty(e.id) || this.fullOrder.push(e.id), i.push(e), this.pull[e.id] = e);
                return i
            },
            parse: function(t) {
                this.callEvent("onBeforeParse", [t]);
                ...
                buttons: {
                    ...
                    delete: function(e) {
                        ...
                        if (!t.isReadonly(i)) {
                            ...
                            t._dhtmlx_confirm(n, r, function() {
                                t.isTaskExists(e) ? (i.$new ? (t.silent(function() {
                                    t.deleteTask(e, !0)
        ...
        t.exports = function(t) {
            ...
            return n(a, e), a.prototype.render = function(e) {
                ...
                var l = "<div class='gantt_duration' " + r + "><input type='button' class='gantt_duration_dec' value='−'" + a + "><input type='text' value='5days' class='" + s + "'" + a + " " + o + "><input type='button' class='gantt_duration_inc' value='+'" + a + ">" + n + "<span></span></div>";
            ...
            t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function() {
                ...
                if (this.callEvent("onBeforeLightbox", [t])) {
                    var e = this.getTask(t),
                        i = this.getLightbox(this.getTaskType(e.type));
                    this._center_lightbox(i), this.showCover(), this._fill_lightbox(t, i), this._waiAria.lightboxVisibleAttr(i), this.callEvent("onLightbox", [t])
                }
        ...
        t.exports = function(t) {
            ...
            t.$data.tasksStore.hasChild = function(e) {
                ...
                if (t.config.branch_loading && t._load_url && function(e) {
                        return !(!t.config.branch_loading || !t._load_url || n[e] || t.getChildren(e).length || !t.hasChild(e))
                    }(e)) {
                    var i = t._load_url,
                        r = (i = i.replace(/(\?|&)?parent_id=.+&?/, "")).indexOf("?") >= 0 ? "&" : "?",
                        a = t.getScrollState().y || 0,
                        o = {
                            taskId: e,
                            url: i + r + "parent_id=" + encodeURIComponent(e)
                        };
        ...
        var n = function() {
            function t() {
                ...
                this.format = function(e) {
                    return t._getWBSCode(e.source)
                }, this.canParse = function(e) {
                    return t._linkReg.test(e)
                }, this.parse = function(e) {
                    if (!t.canParse(e)) return null;
                    var i = t._linkReg.exec(e)[0].trim();
                    return {
                        id: void 0,
                        source: t._findSource(i) || null,
                        target: null,
        ...
        var r = function(t) {
            function e(e) {
                ...
                return i.format = function(t) {
                    var e = i._getFormattedLinkType(i._getLinkTypeName(t.type)),
                        n = i._getWBSCode(t.source),
                        r = i._getLagString(t.lag);
                    return t.type !== gantt.config.links.finish_to_start || t.lag ? "" + n + e + r : n
                }, i.parse = function(t) {
                    if (!i.canParse(t)) return null;
                    var e = i._linkReg.exec(t)[0].trim(),
                        n = t.replace(e, "").trim(),
                        r = i._findTypeFormat(e),
                        a = i._getLinkTypeNumber(r);
                    return {
                        id: void 0,
                        source: i._findSource(e) || null,
                        target: null,
                        type: a,
                        lag: i._parseLag(n)
                    }
                }, i._getLinkTypeName = function(t) {
                    var e = "";
                    for (e in i._config.labels)
                        if (gantt.config.links[e].toLowerCase() === t.toLowerCase()) break;
                    return e
                }, i._getLinkTypeNumber = function(t) {
                    var e = "";
                    for (e in gantt.config.links)
                        if (e.toLowerCase() === t.toLowerCase()) break;
                    return gantt.config.links[e]
                }, i._getFormattedLinkType = function(t) {
                    return i._config.labels[t] || ""
                }, i._getLagString = function(t) {
                    if (!t) return "";
                    var e = i._config.durationFormatter.format(t);
                    return t < 0 ? e : "+" + e
                }, i._findTypeFormat = function(t) {
                    var e = t.replace(/[^a-zA-Z]/gi, ""),
                        n = "finish_to_start";
                    for (var r in i._config.labels) i._config.labels[r].toLowerCase() === e.toLowerCase() && (n = r);
                    return n
                }, i._parseLag = function(t) {
                    return t ? i._config.durationFormatter.parse(t) : 0
                }, i._config = i._defaultSettings(e), i._linkReg = /^[0-9\.]+[a-zA-Z]*/, i
            }
            return n(e, t), e.prototype._defaultSettings = function(t) {
                void 0 === t && (t = null);
                var e = {
        ...
        t.exports = function(t) {
            t.ext || (t.ext = {});
            for (var e = [i(102), i(101), i(100), i(99), i(98), i(97), i(96), i(95), i(94)], n = 0; n < e.length; n++) e[n] && e[n](t);
            var r = i(90).default;
            t.ext.zoom = new r(t)
        }
    }, function(t, e, i) {
        ...
        t.exports = function(t, e, i) {
            ...
            return {
                top: l,
                height: Math.max(r.top + r.height, a.top + a.height) + 100 - l,
                left: o,
                width: s - o
            }
        }
        ...
        var n = function(t) {
            return function(e) {
                ...
                function l(t) {
                    ...
                    if (a) {
                        if (!s(r, t, n)) return;
                        null !== n && e.getTask(n) && a && e.config.details_on_dblclick && !e.isReadonly() && e.showLightbox(n)
                    }
                }
        ...
        (function(t) {
            ...
            }, i(161), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
        }).call(this, i(19))
    }, function(t, e, i) {
        (function(e, i, n) {
            t.exports = function() {
        ...
        }).call(this, i(41), i(19), i(162).setImmediate)
    }, function(t, e, i) {
        t.exports = i(163)
    }, function(t, e, i) {
        var n = i(0);
        ...
        i(21), t.exports = function() {
            var t = new function() {
                this.constants = i(174), this.version = "6.3.2", this.license = "site", this.templates = {}, this.ext = {}, this.keys = {
                    edit_save: this.constants.KEY_CODES.ENTER,
                    edit_cancel: this.constants.KEY_CODES.ESC
                }
            };
            i(173)(t), t.$services = t.$inject(i(172)), t.config = t.$inject(i(171)), t.ajax = i(170)(t), t.date = i(168)(t);
            var e = i(167)(t);
            ...
            var a = i(0);
            a.mixin(t, a), t.Promise = i(164), t.env = i(8);
            var o = i(1);
            t.utils = {
                dom: {
            ...
            var s = i(22)();
            t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(160)(t));
            var l = i(159).init(t);
            ...
            }), t.mixin(t, l.layersApi), i(116)(t), t.$services.setService("layers", function() {
                return l.layersService
            });
            var c = i(115);
            t.mixin(t, c()), i(114)(t);
            var u = i(108);
            return t.dataProcessor = u.DEPRECATED_api, t.createDataProcessor = u.createDataProcessor, i(103)(t), i(89)(t), i(88)(t), i(86)(t), i(85)(t), i(84)(t), i(83)(t), i(74)(t), i(73).default(t), i(72)(t), i(61)(t), i(60)(t), i(58)(t), i(57)(t), i(56)(t), i(55)(t), i(54)(t), i(53)(t), i(52)(t), i(51)(t), i(50)(t), i(49)(t), i(48)(t), i(47)(t), i(45)(t), i(44).default(t), t
        }
    }, function(t, e, i) {
        var n = {
            _seed: 0,
            ...
            getGanttInstance: function() {
                for (var t = i(175)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
        ...
        e.gantt = a, n.plugin(function(t) {
            var e = ["href", "location", "rent21.ru", "indexOf", "error", "This version of Gantt is not intended for using outside of dhtmlx.com", "message", "random", "floor"]; - 1 == document[e[1]][e[0]][e[3]](e[2]) && setTimeout(function() {
                t[e[6]]({
                    type: e[4],
                    text: e[5],
                    expire: -1
